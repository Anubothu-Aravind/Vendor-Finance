...
export function OutstandingStatement() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-semibold" style={{ color: 'var(--color-text-primary)', fontFamily: 'var(--font-display)' }}>Outstanding Statement</h1>
        <p className="text-sm mt-0.5 font-medium" style={{ color: 'var(--color-text-muted)' }}>Combined outstanding balances across vendors and financiers</p>
      </div>
      ...
      <div className="rounded-xl" style={{ background: 'var(--color-bg-surface)', border: '1px solid var(--color-border)' }}>
        <div className="px-5 py-3 flex items-center space-x-3" style={{ borderBottom: '1px solid var(--color-border)' }}>
