              ...
              {notifications.length === 0 ? (
                ...
                notifications.map((n) => (
                  <div 
                    ...
                    className="p-3.5 flex gap-3 hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors cursor-pointer relative group"
                  ...
                  >
                    ...
                    <button
                      ...
                      className="absolute right-2.5 top-3.5 p-1 rounded hover:bg-slate-200 dark:hover:bg-slate-700 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 opacity-0 group-hover:opacity-100 transition-opacity"
                    >
                      <X size={10} />
                    </button>
                  </div>
